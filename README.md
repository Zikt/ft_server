...
[Vvarodi's ft_server](https://github.com/vvarodi/ft_server) Has a great README with good descroptions, so I will link to it. Feel free to check out for clear descvription.
